...
NSString *const NGSDeserializationErrorDomainKey = @"NGSDeserializationErrorDomainKey";

NSInteger const NGSTypeMismatchErrorCode = 143553;

NSInteger const NGSEmptyValueOccurredErrorCode = 143509;

NSInteger const NGSUnknownResponseObjectErrorCode = 143528;


@interface NGSResponseDeserializer ()
...
@implementation NGSResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:NGSDeserializationErrorDomainKey code:NGSTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:NGSDeserializationErrorDomainKey code:NGSEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:NGSDeserializationErrorDomainKey code:NGSUnknownResponseObjectErrorCode userInfo:userInfo];
}
